...
import gabor.var.history.debug.DebugIcons;
...
//                .registerToolWindow(com.intellij.openapi.wm.RegisterToolWindowTask.closable(DebugResources.HISTORY_TAB_NAME, DebugIcons.VARIABLES_TAB_ICON));
    ...
    public void showToolWindow(@NotNull List<StackFrame> stackFrames, @NotNull StackFrame currentFrame, @NotNull String tabName) {
        ...
        Content content = SERVICE.getInstance().createContent(debuggerTab.getLayoutComponent(), tabName, false);
